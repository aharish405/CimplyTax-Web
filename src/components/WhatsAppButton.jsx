...
export default function WhatsAppButton() {
  return (
    <motion.a
      ...
      className="fixed bottom-6 right-6 z-50 w-14 h-14 rounded-full bg-[#25D366] hover:bg-[#20bd5a] flex items-center justify-center text-white transition-all duration-200 hover:scale-110"
      style={{ boxShadow: '0 8px 32px -4px rgba(37, 211, 102, 0.5)' }}
